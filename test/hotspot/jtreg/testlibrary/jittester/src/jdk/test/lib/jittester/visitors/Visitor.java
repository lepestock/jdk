...
public interface Visitor<T> {
    ...
    T visit(CollectionCreation node);
    T visit(CollectionElement node);
    T visit(CollectionExtraction node);
    T visit(CollectionInitializer node);
