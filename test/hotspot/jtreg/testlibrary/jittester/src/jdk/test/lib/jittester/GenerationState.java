 ...
 * Current scope: {@link SymbolTable} and {@link TypeList}.
 */
public final class GenerationState {
    ...
    public static Checkpoint checkpoint() {
        return new Checkpoint(SymbolTable.checkpoint(), TypeList.checkpoint());
    }
    ...
    public static final class Checkpoint {
        ...
        private Checkpoint(int symbolCheckpoint, int typeCheckpoint) {
